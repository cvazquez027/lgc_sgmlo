...
// Validación de Ciberseguridad: Solo exigimos la Matriz (El resumen legal ya NO es obligatorio)
...
try {
    ...
    // 4. SINCRONIZACIÓN N:M (Normativas)
    ...
    // 5. SINCRONIZACIÓN N:M (Documentos)
